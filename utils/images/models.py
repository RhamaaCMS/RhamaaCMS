...
class CustomImage(AbstractImage):
    ...
    def ensure_dimensions(self):
        ...
        self.file.open()
        detected_width, detected_height = get_image_dimensions(self.file)
        self.width = detected_width or 1
        self.height = detected_height or 1
        self.save(update_fields=["width", "height"])

    def get_rendition(self, *args, **kwargs):
        self.ensure_dimensions()
        return super().get_rendition(*args, **kwargs)
